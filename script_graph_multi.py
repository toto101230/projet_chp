...
# Compiler le fichier mutliattack. du sous-dossier projet_base
os.system('cd projet_base && gcc -o multi multiattack.c -Wall && cd ..')
...
while OMP_NUM_THREADS <= NB_MAX_THREAD:
    ...
    for i in range(nb_exec):
        ...
        os.system(f'./projet_base/multi '+str(OMP_NUM_THREADS)+' projet_base/dictSortie.txt projet_base/shadowSmall.txt')
    OMP_NUM_THREADS += 1
